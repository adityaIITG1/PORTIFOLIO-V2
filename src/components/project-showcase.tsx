...
import { Github, ExternalLink, Terminal, ArrowRight, Sparkles, Brain, Zap } from "lucide-react";
...
const projects = [
    {
        ...
        description: "Real-time pose correction system using Computer Vision. Detects 15+ yoga asanas with 98% accuracy and provides instant voice feedback.",
        tags: ["Python", "OpenCV", "MediaPipe", "TensorFlow"],
        color: "from-green-400 to-emerald-600",
        icon: <Zap className="w-6 h-6 text-white" />,
        link: "https://github.com/adityaIITG1/Yoga-AI"
    },
    {
        title: "Generative Art Engine",
        description: "Text-to-Art generation pipeline. Uses stable diffusion concepts to transform natural language prompts into stunning abstract digital artwork.",
        tags: ["TypeScript", "Next.js", "Stable Diffusion", "WebGL"],
        color: "from-purple-400 to-pink-600",
        icon: <Sparkles className="w-6 h-6 text-white" />,
        link: "https://github.com/adityaIITG1"
    },
    {
        title: "Automated Trading Bot",
        description: "High-frequency trading agent powered by Reinforcement Learning. Analyzes market trends and executes sub-millisecond trades.",
        tags: ["Python", "PyTorch", "RL", "Pandas"],
